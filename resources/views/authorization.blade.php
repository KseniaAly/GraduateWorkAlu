    ...
    <div class="d-flex justify-content-between" style="margin-top: 100px">
        <div>
            <div class="mine" style="padding-bottom: 0; border-bottom-left-radius: 0; border-bottom-right-radius: 0">
                <h1 style="margin-bottom: 0">Авторизация</h1>
            </div>
            <form action="{{route('login')}}" method="post" style="position: relative; border-top-left-radius: 0; width: 165%;
                ...
                border-top-right-radius: 0; border-top-left-radius: 0">
                    <button type="submit" class="btn btn-mine">войти</button>
                </div>
            </form>
        </div>
        <div style="width: 45%" class="d-flex flex-column align-items-end">
            ...
            <div class="mine" style="border-top-right-radius: 0; text-align: right">
                <p class="text">Если у вас еще нет акаунта, <a href="{{route('registration')}}">зарегистрируйтесь</a></p>
            </div>
        </div>
    </div>
